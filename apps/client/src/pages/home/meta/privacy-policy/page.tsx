...
export const PrivacyPolicyPage = () => (
  <main className="relative isolate bg-background">
    <Helmet prioritizeSeoTags>
      <title>
        {t`Privacy Policy`} - {t`Awaqi Resume`}
      </title>
      ...
      <ol>
        <li>
          ...
          <p>
            ...
            you provide when using our web application. By accessing or using AWAQI Resume, you
        ...
        <li>
          ...
          <p>
            AWAQI Resume is committed to ensuring the security of your data. Our application and
